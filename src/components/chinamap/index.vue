      ...
      this.chart.setOption({
        tooltip: {
          ...
          formatter: function(e) {
            // console.log(e)
            return e.data.country_name + '<br />' + 'existing:' +e.value + '<br />' + 'cumulative:' + e.data.cumulative + '<br />' + 'death:' + e.data.death + '<br />' + 'cure:' + e.data.cure 
          }
        },
//         #2e0402
// #430806
...
// #f19f9d
        ...
        series: [{
          type: 'map', // 类型
            ...
            emphasis: {
              label: {
                show: false, // 是否显示标签
                color: '#FF6347' // 文字的颜色 如果设置为 'auto'，则为视觉映射得到的颜色，如系列色
              },
              itemStyle: {
                areaColor: '#8C8C8C' // 地图区域的颜色
              }
            },
            itemStyle: {
              normal: {
      ...
      if(document.body.clientWidth > 450){
        this.chart.resize({height:'500px'}); 
      }else{
        this.chart.resize({height:'300px'}); 
      }
    }
  }
}
